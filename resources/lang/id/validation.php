    ...
    */
    ...
    'custom' => [
        'nim' => [
            ...
            'string' => 'Kolom NIM harus berupa string',
            'size' => 'Kolom NIM harus :size angka',
        ...
        'jenis_kelamin' => [
            ...
            'date' => 'Kolom JENIS KELAMIN harus diisi L atau P'
        ],
        'tanggal_lahir' => [
        ...
        'foto' => [
            'image' => 'Kolom Foto hanya bolrh berisi file gambar.',
            'max' => 'Ukuran FOTO tidak boleh lebih dari 500kb.',
            'mimes' => 'Kolom FOTO hanya boleh diisi file *.jpg, *.jpeg, *.bmp, *.png.',
            'dimesions' => 'FOTO harus berukuran 150x180 pixel.',
        ],
    ],
